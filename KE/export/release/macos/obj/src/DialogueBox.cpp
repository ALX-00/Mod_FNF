...
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_180_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",180,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_224_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",224,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_234_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",234,0x0149b4eb)
...
HXLINE( 250)		this->isEnding = false;
HXLINE( 177)		this->dialogueStarted = false;
HXLINE( 176)		this->dialogueOpened = false;
...
HXLINE(  66)		::String _hx_switch_1 = ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase();
            		if (  (_hx_switch_1==HX_("ho",07,5b,00,00)) ){
HXLINE(  91)			hasDialog = true;
HXLINE(  92)			 ::flixel::FlxSprite _hx_tmp = this->box;
HXDLIN(  92)			::String library = null();
HXDLIN(  92)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  92)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  93)			this->box->animation->addByPrefix(HX_("normalOpen",91,41,38,70),HX_("Text Box Appear",bd,48,54,1a),24,false,null(),null());
HXLINE(  94)			this->box->animation->addByIndices(HX_("normal",27,72,69,30),HX_("Text Box Appear",bd,48,54,1a),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_4,1),HX_("",00,00,00,00),24,null(),null(),null());
...
HXLINE(  79)			this->box->animation->addByIndices(HX_("normal",27,72,69,30),HX_("SENPAI ANGRY IMPACT SPEECH",f9,17,39,87),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_5,1),HX_("",00,00,00,00),24,null(),null(),null());
...
HXLINE(  72)			this->box->animation->addByIndices(HX_("normal",27,72,69,30),HX_("Text Box Appear",bd,48,54,1a),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_6,1),HX_("",00,00,00,00),24,null(),null(),null());
...
HXLINE(  85)			this->box->animation->addByIndices(HX_("normal",27,72,69,30),HX_("Spirit Textbox spawn",ea,ee,35,84),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_7,1),HX_("",00,00,00,00),24,null(),null(),null());
...
HXLINE(  81)			goto _hx_goto_1;
            		...
            		_hx_goto_1:;
HXLINE(  97)		this->dialogueList = dialogueList;
HXLINE(  99)		if (!(hasDialog)) {
HXLINE( 100)			return;
            		}
HXLINE( 102)		bool _hx_tmp2;
HXDLIN( 102)		bool _hx_tmp3;
HXDLIN( 102)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() != HX_("senpai",3c,df,8d,6b))) {
HXLINE( 102)			_hx_tmp3 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("roses",04,6c,64,ed));
            		}
            		else {
HXLINE( 102)			_hx_tmp3 = true;
            		}
HXDLIN( 102)		if (!(_hx_tmp3)) {
HXLINE( 102)			_hx_tmp2 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            		}
            		else {
HXLINE( 102)			_hx_tmp2 = true;
            		}
HXDLIN( 102)		if (_hx_tmp2) {
HXLINE( 104)			this->portraitLeft =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-20,40,null());
HXLINE( 105)			 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 105)			::String library = null();
HXDLIN( 105)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 105)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 106)			this->portraitLeft->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Senpai Portrait Enter",d7,e0,09,14),24,false,null(),null());
HXLINE( 107)			 ::flixel::FlxSprite _hx_tmp2 = this->portraitLeft;
HXDLIN( 107)			Float _hx_tmp3 = this->portraitLeft->get_width();
HXDLIN( 107)			_hx_tmp2->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp3 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 108)			this->portraitLeft->updateHitbox();
HXLINE( 109)			this->portraitLeft->scrollFactor->set(null(),null());
HXLINE( 110)			this->add(this->portraitLeft);
HXLINE( 111)			this->portraitLeft->set_visible(false);
HXLINE( 113)			this->portraitRight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,40,null());
HXLINE( 114)			 ::flixel::FlxSprite _hx_tmp4 = this->portraitRight;
HXDLIN( 114)			::String library1 = null();
HXDLIN( 114)			::String _hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 114)			_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE( 115)			this->portraitRight->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Boyfriend portrait enter",a9,02,f8,de),24,false,null(),null());
HXLINE( 116)			 ::flixel::FlxSprite _hx_tmp6 = this->portraitRight;
HXDLIN( 116)			Float _hx_tmp7 = this->portraitRight->get_width();
HXDLIN( 116)			_hx_tmp6->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp7 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 117)			this->portraitRight->updateHitbox();
HXLINE( 118)			this->portraitRight->scrollFactor->set(null(),null());
HXLINE( 119)			this->add(this->portraitRight);
HXLINE( 120)			this->portraitRight->set_visible(false);
            		}
            		else {
HXLINE( 122)			if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("ho",07,5b,00,00))) {
HXLINE( 124)				this->portraitLeft =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-20,40,null());
HXLINE( 125)				 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 125)				::String library = null();
HXDLIN( 125)				::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/caraAlva",27,d3,8f,05)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 125)				_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/caraAlva",27,d3,8f,05)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE( 127)				 ::flixel::FlxSprite _hx_tmp2 = this->portraitLeft;
HXDLIN( 127)				Float _hx_tmp3 = this->portraitLeft->get_width();
HXDLIN( 127)				_hx_tmp2->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp3 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 128)				this->portraitLeft->updateHitbox();
HXLINE( 129)				this->portraitLeft->scrollFactor->set(null(),null());
HXLINE( 130)				this->add(this->portraitLeft);
HXLINE( 131)				this->portraitLeft->set_visible(false);
HXLINE( 133)				this->portraitRight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,40,null());
HXLINE( 134)				 ::flixel::FlxSprite _hx_tmp4 = this->portraitRight;
HXDLIN( 134)				::String library1 = null();
HXDLIN( 134)				::String _hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/caraMacia",b6,28,c4,b9)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 134)				_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/caraMacia",b6,28,c4,b9)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE( 135)				this->portraitRight->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Boyfriend portrait enter",a9,02,f8,de),24,false,null(),null());
HXLINE( 136)				 ::flixel::FlxSprite _hx_tmp6 = this->portraitRight;
HXDLIN( 136)				Float _hx_tmp7 = this->portraitRight->get_width();
HXDLIN( 136)				_hx_tmp6->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp7 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 137)				this->portraitRight->updateHitbox();
HXLINE( 138)				this->portraitRight->scrollFactor->set(null(),null());
HXLINE( 139)				this->add(this->portraitRight);
HXLINE( 140)				this->portraitRight->set_visible(false);
            			}
            		}
HXLINE( 143)		this->box->animation->play(HX_("normalOpen",91,41,38,70),null(),null(),null());
HXLINE( 144)		 ::flixel::FlxSprite _hx_tmp4 = this->box;
HXDLIN( 144)		Float _hx_tmp5 = this->box->get_width();
HXDLIN( 144)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp5 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 145)		this->box->updateHitbox();
HXLINE( 146)		this->add(this->box);
HXLINE( 148)		this->box->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 149)		this->portraitLeft->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 151)		 ::flixel::FlxSprite _hx_tmp6 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.9)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9)),null());
HXDLIN( 151)		::String library = null();
HXDLIN( 151)		this->handSelect = _hx_tmp6->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 152)		this->add(this->handSelect);
HXLINE( 155)		bool _hx_tmp7 = !(talkingRight);
HXLINE( 160)		this->dropText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,242,502,::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.6))),HX_("",00,00,00,00),32,null());
HXLINE( 161)		this->dropText->set_font(HX_("Pixel Arial 11 Bold",ae,17,c6,45));
HXLINE( 162)		this->dropText->set_color(-2583404);
HXLINE( 163)		this->add(this->dropText);
HXLINE( 165)		this->swagDialogue =  ::flixel::addons::text::FlxTypeText_obj::__alloc( HX_CTX ,( (Float)(240) ),( (Float)(500) ),::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.6))),HX_("",00,00,00,00),32,null());
HXLINE( 166)		this->swagDialogue->set_font(HX_("Pixel Arial 11 Bold",ae,17,c6,45));
HXLINE( 167)		this->swagDialogue->set_color(-12640223);
HXLINE( 168)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp8 = ::flixel::FlxG_obj::sound;
HXDLIN( 168)		 ::flixel::_hx_system::FlxSound _hx_tmp9 = _hx_tmp8->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 168)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp9);
HXLINE( 169)		this->add(this->swagDialogue);
HXLINE( 171)		this->dialogue =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(80) ),HX_("",00,00,00,00),false,true,null());
            	}
...
void DialogueBox_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_180_update)
HXLINE( 179)		 ::DialogueBox _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 182)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("roses",04,6c,64,ed))) {
HXLINE( 183)			this->portraitLeft->set_visible(false);
            		}
HXLINE( 184)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c))) {
HXLINE( 186)			this->portraitLeft->set_color(-16777216);
HXLINE( 187)			this->swagDialogue->set_color(-1);
HXLINE( 188)			this->dropText->set_color(-16777216);
            		}
HXLINE( 191)		this->dropText->set_text(this->swagDialogue->text);
HXLINE( 193)		if (::hx::IsNotNull( this->box->animation->_curAnim )) {
HXLINE( 195)			bool _hx_tmp;
HXDLIN( 195)			if ((this->box->animation->_curAnim->name == HX_("normalOpen",91,41,38,70))) {
HXLINE( 195)				_hx_tmp = this->box->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 195)				_hx_tmp = false;
            			}
HXDLIN( 195)			if (_hx_tmp) {
HXLINE( 197)				this->box->animation->play(HX_("normal",27,72,69,30),null(),null(),null());
HXLINE( 198)				this->dialogueOpened = true;
            			}
            		}
HXLINE( 202)		bool _hx_tmp;
HXDLIN( 202)		if (this->dialogueOpened) {
HXLINE( 202)			_hx_tmp = !(this->dialogueStarted);
            		}
            		else {
...
HXLINE( 205)			this->dialogueStarted = true;
            		}
HXLINE( 208)		bool _hx_tmp1;
HXDLIN( 208)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 208)			_hx_tmp1 = (this->dialogueStarted == true);
            		}
            		else {
HXLINE( 208)			_hx_tmp1 = false;
            		}
HXDLIN( 208)		if (_hx_tmp1) {
HXLINE( 210)			this->remove(this->dialogue,null());
HXLINE( 212)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 212)			_hx_tmp->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
HXLINE( 214)			bool _hx_tmp1;
HXDLIN( 214)			if (::hx::IsNull( this->dialogueList->__get(1) )) {
HXLINE( 214)				_hx_tmp1 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            			}
            			else {
HXLINE( 214)				_hx_tmp1 = false;
            			}
HXDLIN( 214)			if (_hx_tmp1) {
HXLINE( 216)				if (!(this->isEnding)) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_224_update)
HXLINE( 225)						{
HXLINE( 225)							 ::flixel::FlxSprite _g = _gthis->box;
HXDLIN( 225)							_g->set_alpha((_g->alpha - ((Float)0.2)));
            						}
HXLINE( 226)						{
HXLINE( 226)							 ::flixel::FlxSprite _g1 = _gthis->bgFade;
HXDLIN( 226)							_g1->set_alpha((_g1->alpha - ((Float)0.139999999999999986)));
            						}
HXLINE( 227)						_gthis->portraitLeft->set_visible(false);
HXLINE( 228)						_gthis->portraitRight->set_visible(false);
HXLINE( 229)						{
HXLINE( 229)							 ::flixel::addons::text::FlxTypeText _g2 = _gthis->swagDialogue;
HXDLIN( 229)							_g2->set_alpha((_g2->alpha - ((Float)0.2)));
            						}
HXLINE( 230)						_gthis->dropText->set_alpha(_gthis->swagDialogue->alpha);
            					}
            					HX_END_LOCAL_FUNC1((void))

            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_234_update)
HXLINE( 235)						_gthis->finishThing();
HXLINE( 236)						_gthis->kill();
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 218)					this->isEnding = true;
HXLINE( 220)					bool _hx_tmp;
HXDLIN( 220)					if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() != HX_("senpai",3c,df,8d,6b))) {
HXLINE( 220)						_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            					}
            					else {
HXLINE( 220)						_hx_tmp = true;
            					}
HXDLIN( 220)					if (_hx_tmp) {
HXLINE( 221)						 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 221)						 ::Dynamic To = 0;
HXDLIN( 221)						 ::Dynamic onComplete = null();
HXDLIN( 221)						if (::hx::IsNull( To )) {
HXLINE( 221)							To = 0;
            						}
HXDLIN( 221)						if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 221)							_this->fadeTween->cancel();
            						}
HXDLIN( 221)						_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(_this->_volume,( (Float)(To) ),((Float)2.2), ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            					}
HXLINE( 223)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.2), ::Dynamic(new _hx_Closure_0(_gthis)),5);
HXLINE( 233)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)1.2), ::Dynamic(new _hx_Closure_1(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 242)				this->dialogueList->remove(this->dialogueList->__get(0));
HXLINE( 243)				this->startDialogue();
            			}
            		}
...
HXLINE( 254)		this->cleanDialog();
HXLINE( 260)		this->swagDialogue->resetText(this->dialogueList->__get(0));
HXLINE( 261)		this->swagDialogue->start(((Float)0.04),true,null(),null(),null());
HXLINE( 263)		::String _hx_switch_0 = this->curCharacter;
            		if (  (_hx_switch_0==HX_("bf",c4,55,00,00)) ){
HXLINE( 273)			this->portraitLeft->set_visible(false);
HXLINE( 274)			if (!(this->portraitRight->visible)) {
HXLINE( 276)				this->portraitRight->set_visible(true);
HXLINE( 277)				this->portraitRight->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 272)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("dad",47,36,4c,00)) ){
HXLINE( 266)			this->portraitRight->set_visible(false);
HXLINE( 267)			if (!(this->portraitLeft->visible)) {
HXLINE( 269)				this->portraitLeft->set_visible(true);
HXLINE( 270)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 265)			goto _hx_goto_11;
            		}
            		_hx_goto_11:;
            	}
