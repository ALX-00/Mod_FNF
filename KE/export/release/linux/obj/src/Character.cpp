...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_570_update,"Character","update",0x0e18944e,"Character.update","Character.hx",570,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_607_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",607,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_668_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",668,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_699_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",699,0xf073a2d5)
...
HXLINE( 381)			::String library = null();
HXDLIN( 381)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfCar",4b,f2,0a,1e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 381)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfCar",4b,f2,0a,1e)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 382)			this->set_frames(tex1);
HXLINE( 383)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
HXLINE( 384)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF NOTE UP0",23,e8,67,d4),24,false,null(),null());
HXLINE( 385)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF NOTE LEFT0",77,e0,7c,76),24,false,null(),null());
HXLINE( 386)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF NOTE RIGHT0",06,3f,26,eb),24,false,null(),null());
HXLINE( 387)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF NOTE DOWN0",bc,3f,f1,e1),24,false,null(),null());
HXLINE( 388)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF NOTE UP MISS",8f,08,36,ae),24,false,null(),null());
HXLINE( 389)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF NOTE LEFT MISS",e3,ba,cf,a7),24,false,null(),null());
HXLINE( 390)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF NOTE RIGHT MISS",f2,0c,cd,25),24,false,null(),null());
HXLINE( 391)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF NOTE DOWN MISS",a8,a0,05,a9),24,false,null(),null());
HXLINE( 393)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 394)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 395)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 396)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 397)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 398)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 399)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 400)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 401)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 402)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 404)			this->set_flipX(true);
HXLINE( 380)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-christmas",79,02,f4,24)) ){
HXLINE( 353)			::String library = null();
HXDLIN( 353)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfChristmas",f9,be,84,ca)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 353)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfChristmas",f9,be,84,ca)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 354)			this->set_frames(tex1);
HXLINE( 355)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
...
HXLINE( 364)			this->animation->addByPrefix(HX_("hey",dc,42,4f,00),HX_("BF HEY",60,1e,f8,c6),24,false,null(),null());
...
HXLINE( 377)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 379)			this->set_flipX(true);
HXLINE( 352)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-pixel",fd,03,90,37)) ){
HXLINE( 406)			::String library = null();
HXDLIN( 406)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixel",7d,80,e8,6d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 406)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixel",7d,80,e8,6d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 407)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF IDLE",f0,de,ca,52),24,false,null(),null());
HXLINE( 408)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF UP NOTE",7b,9d,4e,d3),24,false,null(),null());
HXLINE( 409)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF LEFT NOTE",4f,b9,34,d9),24,false,null(),null());
HXLINE( 410)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF RIGHT NOTE",b2,df,15,96),24,false,null(),null());
HXLINE( 411)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF DOWN NOTE",14,9f,6a,da),24,false,null(),null());
HXLINE( 412)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF UP MISS",85,d8,a0,d2),24,false,null(),null());
HXLINE( 413)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF LEFT MISS",59,f4,86,d8),24,false,null(),null());
HXLINE( 414)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF RIGHT MISS",bc,1a,68,95),24,false,null(),null());
HXLINE( 415)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF DOWN MISS",1e,da,bc,d9),24,false,null(),null());
HXLINE( 417)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 418)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 419)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 420)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 421)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 422)			this->addOffset(HX_("singUPmiss",66,22,08,8a),null(),null());
HXLINE( 423)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),null(),null());
HXLINE( 424)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),null(),null());
HXLINE( 425)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),null(),null());
HXLINE( 427)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 428)			this->updateHitbox();
HXLINE( 430)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 432)			{
HXLINE( 432)				 ::Character _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 432)				_g->set_width((_g->get_width() - ( (Float)(100) )));
            			}
HXLINE( 433)			{
HXLINE( 433)				 ::Character _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 433)				_g1->set_height((_g1->get_height() - ( (Float)(100) )));
            			}
HXLINE( 435)			this->set_antialiasing(false);
HXLINE( 437)			this->set_flipX(true);
HXLINE( 405)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-pixel-dead",34,d0,3d,c4)) ){
HXLINE( 439)			::String library = null();
HXDLIN( 439)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixelsDEAD",fa,66,1f,36)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 439)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixelsDEAD",fa,66,1f,36)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 440)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 441)			this->animation->addByPrefix(HX_("firstDeath",e4,d8,fc,14),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 442)			this->animation->addByPrefix(HX_("deathLoop",b8,0b,79,2e),HX_("Retry Loop",5c,76,15,41),24,true,null(),null());
HXLINE( 443)			this->animation->addByPrefix(HX_("deathConfirm",2c,44,2b,12),HX_("RETRY CONFIRM",08,8c,5f,fd),24,false,null(),null());
HXLINE( 444)			this->animation->play(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
HXLINE( 446)			this->addOffset(HX_("firstDeath",e4,d8,fc,14),null(),null());
HXLINE( 447)			this->addOffset(HX_("deathLoop",b8,0b,79,2e),-37,null());
HXLINE( 448)			this->addOffset(HX_("deathConfirm",2c,44,2b,12),-37,null());
HXLINE( 449)			this->playAnim(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
HXLINE( 451)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 452)			this->updateHitbox();
HXLINE( 453)			this->set_antialiasing(false);
HXLINE( 454)			this->set_flipX(true);
...
HXLINE( 109)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("macia",27,68,16,03)) ){
HXLINE( 311)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/macia",c2,91,3d,70)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 311)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/macia",c2,91,3d,70)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d)));
HXLINE( 312)			this->set_frames(tex1);
HXLINE( 314)			::haxe::Log_obj::trace(tex1->frames->length,::hx::SourceInfo(HX_("source/Character.hx",c9,4f,91,f5),314,HX_("Character",89,bb,a4,e3),HX_("new",60,d0,53,00)));
...
HXLINE( 327)			this->animation->addByPrefix(HX_("firstDeath",e4,d8,fc,14),HX_("BF dies",0f,cb,bf,64),24,false,null(),null());
HXLINE( 328)			this->animation->addByPrefix(HX_("deathLoop",b8,0b,79,2e),HX_("BF Dead Loop",04,f4,36,2f),24,true,null(),null());
HXLINE( 329)			this->animation->addByPrefix(HX_("deathConfirm",2c,44,2b,12),HX_("BF Dead confirm",80,6b,f9,23),24,false,null(),null());
HXLINE( 331)			this->animation->addByPrefix(HX_("scared",20,78,2a,3c),HX_("BF idle shaking",53,d0,da,8d),24,null(),null(),null());
HXLINE( 333)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 334)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 335)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 336)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 337)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 338)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 339)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 340)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 341)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 342)			this->addOffset(HX_("hey",dc,42,4f,00),7,4);
HXLINE( 343)			this->addOffset(HX_("firstDeath",e4,d8,fc,14),37,11);
HXLINE( 344)			this->addOffset(HX_("deathLoop",b8,0b,79,2e),37,5);
HXLINE( 345)			this->addOffset(HX_("deathConfirm",2c,44,2b,12),37,69);
HXLINE( 346)			this->addOffset(HX_("scared",20,78,2a,3c),-4,null());
...
HXLINE( 518)			::String library = null();
HXDLIN( 518)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/mom_dad_christmas_assets",91,39,44,07)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 518)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/mom_dad_christmas_assets",91,39,44,07)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 519)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Parent Christmas Idle",c8,04,64,10),24,false,null(),null());
HXLINE( 520)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Parent Up Note Dad",88,99,f7,ad),24,false,null(),null());
HXLINE( 521)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Parent Down Note Dad",21,a5,93,34),24,false,null(),null());
HXLINE( 522)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Parent Left Note Dad",dc,f8,16,c4),24,false,null(),null());
HXLINE( 523)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Parent Right Note Dad",13,46,28,52),24,false,null(),null());
HXLINE( 525)			this->animation->addByPrefix(HX_("singUP-alt",86,62,b4,5f),HX_("Parent Up Note Mom",0c,7a,fe,ad),24,false,null(),null());
HXLINE( 527)			this->animation->addByPrefix(HX_("singDOWN-alt",cd,29,35,ba),HX_("Parent Down Note Mom",a5,85,9a,34),24,false,null(),null());
HXLINE( 528)			this->animation->addByPrefix(HX_("singLEFT-alt",f2,6f,48,8c),HX_("Parent Left Note Mom",60,d9,1d,c4),24,false,null(),null());
HXLINE( 529)			this->animation->addByPrefix(HX_("singRIGHT-alt",a9,0c,12,b9),HX_("Parent Right Note Mom",97,26,2f,52),24,false,null(),null());
HXLINE( 531)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 532)			this->addOffset(HX_("singUP",6a,52,21,b9),-47,24);
HXLINE( 533)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-1,-23);
HXLINE( 534)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-30,16);
HXLINE( 535)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-31,-29);
HXLINE( 536)			this->addOffset(HX_("singUP-alt",86,62,b4,5f),-47,24);
HXLINE( 537)			this->addOffset(HX_("singRIGHT-alt",a9,0c,12,b9),-1,-24);
HXLINE( 538)			this->addOffset(HX_("singLEFT-alt",f2,6f,48,8c),-30,15);
HXLINE( 539)			this->addOffset(HX_("singDOWN-alt",cd,29,35,ba),-30,-27);
HXLINE( 541)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 517)			goto _hx_goto_0;
            		}
...
HXLINE( 457)			::String library = null();
HXDLIN( 457)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 457)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 458)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Senpai Idle",78,62,c5,a9),24,false,null(),null());
HXLINE( 459)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("SENPAI UP NOTE",f3,26,c1,c4),24,false,null(),null());
HXLINE( 460)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("SENPAI LEFT NOTE",c7,90,76,f3),24,false,null(),null());
HXLINE( 461)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("SENPAI RIGHT NOTE",3a,91,70,75),24,false,null(),null());
HXLINE( 462)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("SENPAI DOWN NOTE",8c,76,ac,f4),24,false,null(),null());
HXLINE( 464)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 465)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 466)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 467)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 468)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 470)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 472)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 473)			this->updateHitbox();
HXLINE( 475)			this->set_antialiasing(false);
HXLINE( 456)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("senpai-angry",10,7a,b8,25)) ){
HXLINE( 477)			::String library = null();
HXDLIN( 477)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 477)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 478)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Angry Senpai Idle",d9,cc,b4,52),24,false,null(),null());
HXLINE( 479)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Angry Senpai UP NOTE",52,97,34,df),24,false,null(),null());
HXLINE( 480)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Angry Senpai LEFT NOTE",e6,16,ee,25),24,false,null(),null());
HXLINE( 481)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Angry Senpai RIGHT NOTE",3b,66,8e,6b),24,false,null(),null());
HXLINE( 482)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Angry Senpai DOWN NOTE",ab,fc,23,27),24,false,null(),null());
HXLINE( 484)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 485)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 486)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 487)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 488)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 489)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 491)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 492)			this->updateHitbox();
HXLINE( 494)			this->set_antialiasing(false);
HXLINE( 476)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("spirit",31,bb,a9,bd)) ){
HXLINE( 497)			::String library = null();
HXDLIN( 497)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/spirit",36,f9,c6,d2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 497)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/spirit",36,f9,c6,d2)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 498)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("idle spirit_",02,2f,37,04),24,false,null(),null());
HXLINE( 499)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("up_",a4,29,59,00),24,false,null(),null());
HXLINE( 500)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("right_",03,55,26,4e),24,false,null(),null());
HXLINE( 501)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("left_",78,fe,56,72),24,false,null(),null());
HXLINE( 502)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("spirit down_",8e,9f,fa,ae),24,false,null(),null());
HXLINE( 504)			this->addOffset(HX_("idle",14,a7,b3,45),-220,-280);
HXLINE( 505)			this->addOffset(HX_("singUP",6a,52,21,b9),-220,-240);
HXLINE( 506)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-220,-280);
HXLINE( 507)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-200,-280);
HXLINE( 508)			this->addOffset(HX_("singDOWN",31,2a,ad,36),170,110);
HXLINE( 510)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 511)			this->updateHitbox();
HXLINE( 513)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 515)			this->set_antialiasing(false);
HXLINE( 496)			goto _hx_goto_0;
            		}
...
HXLINE( 546)		if (( (bool)(isPlayer) )) {
HXLINE( 548)			this->set_flipX(!(this->flipX));
HXLINE( 551)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 554)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 555)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 556)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 559)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 561)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 562)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 563)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_570_update)
...
HXLINE( 575)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 575)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 578)			Float dadVar = ( (Float)(4) );
HXLINE( 580)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 581)				dadVar = ((Float)6.1);
            			}
HXLINE( 582)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 584)				::haxe::Log_obj::trace(HX_("dance",33,83,83,d4),::hx::SourceInfo(HX_("source/Character.hx",c9,4f,91,f5),584,HX_("Character",89,bb,a4,e3),HX_("update",09,86,05,87)));
HXLINE( 585)				this->dance();
HXLINE( 586)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 590)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 593)			bool _hx_tmp;
HXDLIN( 593)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 593)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_607_dance)
HXDLIN( 607)		if (!(this->debugMode)) {
HXLINE( 609)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
...
HXLINE( 612)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 634)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 636)					this->danced = !(this->danced);
HXLINE( 638)					if (this->danced) {
HXLINE( 639)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 641)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 634)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
...
HXLINE( 623)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 644)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 646)					this->danced = !(this->danced);
HXLINE( 648)					if (this->danced) {
HXLINE( 649)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 651)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 644)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 655)				this->danced = !(this->danced);
HXLINE( 657)				if (this->danced) {
HXLINE( 658)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 660)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 654)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 662)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_668_playAnim)
HXLINE( 669)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 671)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 672)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 674)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 677)			this->offset->set(0,0);
            		}
HXLINE( 679)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 681)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 683)				this->danced = true;
            			}
            			else {
HXLINE( 685)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 687)					this->danced = false;
            				}
            			}
HXLINE( 690)			bool _hx_tmp;
HXDLIN( 690)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 690)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 690)				_hx_tmp = true;
            			}
HXDLIN( 690)			if (_hx_tmp) {
HXLINE( 692)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_699_addOffset)
HXDLIN( 699)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 699)		this->animOffsets->set(name,v);
            	}
