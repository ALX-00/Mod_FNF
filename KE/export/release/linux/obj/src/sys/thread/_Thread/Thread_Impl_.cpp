...
HX_LOCAL_STACK_FRAME(_hx_pos_fab82867dae42cec_47_readMessage,"sys.thread._Thread.Thread_Impl_","readMessage",0x4f379df5,"sys.thread._Thread.Thread_Impl_.readMessage","/usr/share/haxe/std/cpp/_std/sys/thread/Thread.hx",47,0x59448795)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Thread_Impl__obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_fab82867dae42cec_47_readMessage)
