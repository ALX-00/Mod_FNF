...
HXLINE( 328)						::haxe::Log_obj::trace((((HX_("outdated lmao! ",46,1a,a2,c7) + returnedData->__get(0)) + HX_(" != ",84,13,40,15)) + ::MainMenuState_obj::kadeEngineVer),::hx::SourceInfo(HX_("source/TitleState.hx",71,4f,0c,46),328,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
...
HXLINE( 340)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source/TitleState.hx",71,4f,0c,46),340,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 341)					{
...
HXLINE( 363)			{
HXLINE( 363)				 ::Alphabet _g1 = money;
HXDLIN( 363)				_g1->set_y((_g1->y + ((i * 60) + 200)));
            			}
...
HXLINE( 373)		{
HXLINE( 373)			 ::Alphabet _g = coolText;
HXDLIN( 373)			_g->set_y((_g->y + ((this->textGroup->length * 60) + 200)));
            		}
