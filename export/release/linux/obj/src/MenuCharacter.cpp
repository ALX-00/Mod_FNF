...
HX_LOCAL_STACK_FRAME(_hx_pos_ab0efa272e315d84_62_setCharacter,"MenuCharacter","setCharacter",0x186f24ab,"MenuCharacter.setCharacter","MenuCharacter.hx",62,0x28a93714)
...
HXLINE(  55)		this->animation->addByPrefix(HX_("dad",47,36,4c,00),HX_("Dad idle dance BLACK LINE",b5,ef,e0,8b),24,null(),null(),null());
HXLINE(  57)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * scale)),null());
...
void MenuCharacter_obj::setCharacter(::String character){
            	HX_STACKFRAME(&_hx_pos_ab0efa272e315d84_62_setCharacter)
HXLINE(  63)		if ((character == HX_("",00,00,00,00))) {
HXLINE(  65)			this->set_visible(false);
HXLINE(  66)			return;
            		}
            		else {
HXLINE(  70)			this->set_visible(true);
            		}
HXLINE(  73)		this->animation->play(character,null(),null(),null());
HXLINE(  75)		 ::CharacterSetting setting = ( ( ::CharacterSetting)(::MenuCharacter_obj::settings->get(character)) );
HXLINE(  76)		this->offset->set(setting->x,setting->y);
HXLINE(  77)		Float _hx_tmp = this->get_width();
HXDLIN(  77)		this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * setting->scale)),null());
HXLINE(  78)		this->set_flipX((setting->flipped != this->flipped));
            	}
