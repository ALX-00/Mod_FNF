...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_148_addSong,"FreeplayState","addSong",0x9e966259,"FreeplayState.addSong","FreeplayState.hx",148,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_152_addWeek,"FreeplayState","addWeek",0xa1339e78,"FreeplayState.addWeek","FreeplayState.hx",152,0x0d86f62d)
static const ::String _hx_array_data_b3f26131_7[] = {
	HX_("dad",47,36,4c,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_167_update,"FreeplayState","update",0x9e1473a6,"FreeplayState.update","FreeplayState.hx",167,0x0d86f62d)
...
HXLINE(  33)		this->intendedScore = 0;
HXLINE(  32)		this->lerpScore = 0;
HXLINE(  28)		this->curDifficulty = 1;
...
HXLINE(  63)		bool isDebug = false;
HXLINE(  73)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  73)		::String library1 = null();
HXDLIN(  73)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBGBlue",de,35,e3,1e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  74)		this->add(bg1);
HXLINE(  76)		this->grpSongs =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  77)		this->add(this->grpSongs);
HXLINE(  79)		{
HXLINE(  79)			int _g2 = 0;
HXDLIN(  79)			int _g3 = this->songs->length;
HXDLIN(  79)			while((_g2 < _g3)){
HXLINE(  79)				_g2 = (_g2 + 1);
HXDLIN(  79)				int i = (_g2 - 1);
HXLINE(  81)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->songs->__get(i).StaticCast<  ::SongMetadata >()->songName,true,false);
HXLINE(  82)				songText->isMenuItem = true;
HXLINE(  83)				songText->targetY = ( (Float)(i) );
HXLINE(  84)				this->grpSongs->add(songText).StaticCast<  ::Alphabet >();
HXLINE(  86)				 ::HealthIcon icon =  ::HealthIcon_obj::__alloc( HX_CTX ,this->songs->__get(i).StaticCast<  ::SongMetadata >()->songCharacter,null());
HXLINE(  87)				icon->sprTracker = songText;
HXLINE(  90)				this->iconArray->push(icon);
HXLINE(  91)				this->add(icon);
            			}
            		}
HXLINE(  98)		this->scoreText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.7)),5,0,HX_("",00,00,00,00),32,null());
HXLINE( 100)		this->scoreText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("right",dc,0b,64,e9),null(),null(),null());
HXLINE( 103)		 ::flixel::FlxSprite scoreBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(this->scoreText->x - ( (Float)(6) )),0,null());
HXDLIN( 103)		 ::flixel::FlxSprite scoreBG1 = scoreBG->makeGraphic(::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))),66,-16777216,null(),null());
HXLINE( 104)		scoreBG1->set_alpha(((Float)0.6));
HXLINE( 105)		this->add(scoreBG1);
HXLINE( 107)		this->diffText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->scoreText->x,(this->scoreText->y + 36),0,HX_("",00,00,00,00),24,null());
HXLINE( 108)		this->diffText->set_font(this->scoreText->_font);
HXLINE( 109)		this->add(this->diffText);
HXLINE( 111)		this->add(this->scoreText);
HXLINE( 113)		this->changeSelection(null());
HXLINE( 114)		this->changeDiff(null());
HXLINE( 118)		this->selector =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 120)		this->selector->set_size(40);
HXLINE( 121)		this->selector->set_text(HX_(">",3e,00,00,00));
HXLINE( 124)		 ::Alphabet swag =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(1) ),( (Float)(0) ),HX_("swag",8a,2a,5e,4c),null(),null());
HXLINE( 143)		this->super::create();
            	}


void FreeplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_148_addSong)
HXDLIN( 148)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 148)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter));
            	}
...
void FreeplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_152_addWeek)
HXLINE( 153)		if (::hx::IsNull( songCharacters )) {
HXLINE( 154)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_7,1);
            		}
HXLINE( 156)		int num = 0;
HXLINE( 157)		{
HXLINE( 157)			int _g = 0;
HXDLIN( 157)			while((_g < songs->length)){
HXLINE( 157)				::String song = songs->__get(_g);
HXDLIN( 157)				_g = (_g + 1);
HXLINE( 159)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 161)				if ((songCharacters->length != 1)) {
HXLINE( 162)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void FreeplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_167_update)
HXLINE( 168)		this->super::update(elapsed);
HXLINE( 170)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 172)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 172)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 175)		Float a = ( (Float)(this->lerpScore) );
HXDLIN( 175)		this->lerpScore = ::Math_obj::floor((a + (((Float)0.4) * (( (Float)(this->intendedScore) ) - a))));
HXLINE( 177)		if ((::Math_obj::abs(( (Float)((this->lerpScore - this->intendedScore)) )) <= 10)) {
HXLINE( 178)			this->lerpScore = this->intendedScore;
            		}
HXLINE( 180)		this->scoreText->set_text((HX_("PERSONAL BEST:",36,ce,e9,ee) + this->lerpScore));
HXLINE( 182)		bool upP = ::PlayerSettings_obj::player1->controls->_upP->check();
HXLINE( 183)		bool downP = ::PlayerSettings_obj::player1->controls->_downP->check();
HXLINE( 184)		bool accepted = ::PlayerSettings_obj::player1->controls->_accept->check();
HXLINE( 186)		if (upP) {
...
HXLINE( 195)		if (::PlayerSettings_obj::player1->controls->_leftP->check()) {
HXLINE( 196)			this->changeDiff(-1);
            		}
HXLINE( 197)		if (::PlayerSettings_obj::player1->controls->_rightP->check()) {
HXLINE( 198)			this->changeDiff(1);
            		}
...
HXLINE( 205)		if (accepted) {
HXLINE( 207)			::String poop = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase();
HXDLIN( 207)			::String poop1 = ::Highscore_obj::formatSong(poop,this->curDifficulty);
HXLINE( 209)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),209,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 211)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase());
HXLINE( 212)			::PlayState_obj::isStoryMode = false;
HXLINE( 213)			::PlayState_obj::storyDifficulty = this->curDifficulty;
HXLINE( 214)			::PlayState_obj::storyWeek = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->week;
HXLINE( 215)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),215,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 216)			{
HXLINE( 216)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 224)		if ((this->curDifficulty < 0)) {
HXLINE( 225)			this->curDifficulty = 2;
            		}
HXLINE( 226)		if ((this->curDifficulty > 2)) {
HXLINE( 227)			this->curDifficulty = 0;
            		}
HXLINE( 230)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 233)		switch((int)(this->curDifficulty)){
            			case (int)0: {
HXLINE( 236)				this->diffText->set_text(HX_("EASY",02,54,cd,2d));
            			}
            			break;
            			case (int)1: {
HXLINE( 238)				this->diffText->set_text(HX_("NORMAL",27,1e,ec,e2));
            			}
            			break;
            			case (int)2: {
HXLINE( 240)				this->diffText->set_text(HX_("HARD",eb,f6,c8,2f));
            			}
            			break;
            		}
            	}
