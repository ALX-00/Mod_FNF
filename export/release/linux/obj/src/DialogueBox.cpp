...
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_157_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",157,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_201_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",201,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_211_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",211,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_230_startDialogue,"DialogueBox","startDialogue",0x59859d9f,"DialogueBox.startDialogue","DialogueBox.hx",230,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_260_cleanDialog,"DialogueBox","cleanDialog",0x0fc249f6,"DialogueBox.cleanDialog","DialogueBox.hx",260,0x0149b4eb)
...
HXLINE( 227)		this->isEnding = false;
...
HXLINE( 102)		this->portraitLeft =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-20,40,null());
HXLINE( 103)		 ::flixel::FlxSprite _hx_tmp2 = this->portraitLeft;
HXDLIN( 103)		::String library = null();
HXDLIN( 103)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 103)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 104)		this->portraitLeft->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Senpai Portrait Enter",d7,e0,09,14),24,false,null(),null());
HXLINE( 105)		 ::flixel::FlxSprite _hx_tmp4 = this->portraitLeft;
HXDLIN( 105)		Float _hx_tmp5 = this->portraitLeft->get_width();
HXDLIN( 105)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp5 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 106)		this->portraitLeft->updateHitbox();
HXLINE( 107)		this->portraitLeft->scrollFactor->set(null(),null());
HXLINE( 108)		this->add(this->portraitLeft);
HXLINE( 109)		this->portraitLeft->set_visible(false);
HXLINE( 111)		this->portraitRight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,40,null());
HXLINE( 112)		 ::flixel::FlxSprite _hx_tmp6 = this->portraitRight;
HXDLIN( 112)		::String library1 = null();
HXDLIN( 112)		::String _hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 112)		_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE( 113)		this->portraitRight->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Boyfriend portrait enter",a9,02,f8,de),24,false,null(),null());
HXLINE( 114)		 ::flixel::FlxSprite _hx_tmp8 = this->portraitRight;
HXDLIN( 114)		Float _hx_tmp9 = this->portraitRight->get_width();
HXDLIN( 114)		_hx_tmp8->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp9 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 115)		this->portraitRight->updateHitbox();
HXLINE( 116)		this->portraitRight->scrollFactor->set(null(),null());
HXLINE( 117)		this->add(this->portraitRight);
HXLINE( 118)		this->portraitRight->set_visible(false);
HXLINE( 120)		this->box->animation->play(HX_("normalOpen",91,41,38,70),null(),null(),null());
HXLINE( 121)		 ::flixel::FlxSprite _hx_tmp10 = this->box;
HXDLIN( 121)		Float _hx_tmp11 = this->box->get_width();
HXDLIN( 121)		_hx_tmp10->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp11 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 122)		this->box->updateHitbox();
HXLINE( 123)		this->add(this->box);
HXLINE( 125)		this->box->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 126)		this->portraitLeft->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 128)		 ::flixel::FlxSprite _hx_tmp12 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.9)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9)),null());
HXDLIN( 128)		::String library2 = null();
HXDLIN( 128)		this->handSelect = _hx_tmp12->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2),null(),null(),null(),null(),null());
HXLINE( 129)		this->add(this->handSelect);
HXLINE( 132)		bool _hx_tmp13 = !(talkingRight);
...
HXLINE( 145)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp14 = ::flixel::FlxG_obj::sound;
HXDLIN( 145)		 ::flixel::_hx_system::FlxSound _hx_tmp15 = _hx_tmp14->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 145)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp15);
HXLINE( 146)		this->add(this->swagDialogue);
HXLINE( 148)		this->dialogue =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(80) ),HX_("",00,00,00,00),false,true);
            	}
...
void DialogueBox_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_157_update)
HXLINE( 156)		 ::DialogueBox _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 159)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("roses",04,6c,64,ed))) {
HXLINE( 160)			this->portraitLeft->set_visible(false);
            		}
HXLINE( 161)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c))) {
HXLINE( 163)			this->portraitLeft->set_color(-16777216);
HXLINE( 164)			this->swagDialogue->set_color(-1);
HXLINE( 165)			this->dropText->set_color(-16777216);
            		}
HXLINE( 168)		this->dropText->set_text(this->swagDialogue->text);
HXLINE( 170)		if (::hx::IsNotNull( this->box->animation->_curAnim )) {
HXLINE( 172)			bool _hx_tmp;
HXDLIN( 172)			if ((this->box->animation->_curAnim->name == HX_("normalOpen",91,41,38,70))) {
HXLINE( 172)				_hx_tmp = this->box->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 172)				_hx_tmp = false;
            			}
HXDLIN( 172)			if (_hx_tmp) {
HXLINE( 174)				this->box->animation->play(HX_("normal",27,72,69,30),null(),null(),null());
HXLINE( 175)				this->dialogueOpened = true;
            			}
            		}
HXLINE( 179)		bool _hx_tmp;
HXDLIN( 179)		if (this->dialogueOpened) {
HXLINE( 179)			_hx_tmp = !(this->dialogueStarted);
            		}
            		else {
HXLINE( 179)			_hx_tmp = false;
            		}
HXDLIN( 179)		if (_hx_tmp) {
HXLINE( 181)			this->startDialogue();
HXLINE( 182)			this->dialogueStarted = true;
            		}
HXLINE( 185)		bool _hx_tmp1;
HXDLIN( 185)		if (( ( ::flixel::input::FlxBaseKeyList)(::flixel::FlxG_obj::keys->justPressed) )->get_ANY()) {
HXLINE( 185)			_hx_tmp1 = (this->dialogueStarted == true);
            		}
            		else {
HXLINE( 185)			_hx_tmp1 = false;
            		}
HXDLIN( 185)		if (_hx_tmp1) {
HXLINE( 187)			this->remove(this->dialogue,null());
HXLINE( 189)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 189)			_hx_tmp->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
HXLINE( 191)			bool _hx_tmp1;
HXDLIN( 191)			if (::hx::IsNull( this->dialogueList->__get(1) )) {
HXLINE( 191)				_hx_tmp1 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            			}
            			else {
...
HXLINE( 193)				if (!(this->isEnding)) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_201_update)
HXLINE( 202)						{
HXLINE( 202)							 ::flixel::FlxSprite _g = _gthis->box;
HXDLIN( 202)							_g->set_alpha((_g->alpha - ((Float)0.2)));
            						}
HXLINE( 203)						{
HXLINE( 203)							 ::flixel::FlxSprite _g1 = _gthis->bgFade;
HXDLIN( 203)							_g1->set_alpha((_g1->alpha - ((Float)0.139999999999999986)));
            						}
HXLINE( 204)						_gthis->portraitLeft->set_visible(false);
HXLINE( 205)						_gthis->portraitRight->set_visible(false);
HXLINE( 206)						{
HXLINE( 206)							 ::flixel::addons::text::FlxTypeText _g2 = _gthis->swagDialogue;
HXDLIN( 206)							_g2->set_alpha((_g2->alpha - ((Float)0.2)));
            						}
HXLINE( 207)						_gthis->dropText->set_alpha(_gthis->swagDialogue->alpha);
            					}
            					HX_END_LOCAL_FUNC1((void))

            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_211_update)
...
HXDLIN( 197)					if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() != HX_("senpai",3c,df,8d,6b))) {
HXLINE( 197)						_hx_tmp1 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            					}
            					else {
HXLINE( 197)						_hx_tmp1 = true;
            					}
HXDLIN( 197)					if (!(_hx_tmp1)) {
HXLINE( 197)						_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("ho",07,5b,00,00));
            					}
            					else {
HXLINE( 197)						_hx_tmp = true;
            					}
HXDLIN( 197)					if (_hx_tmp) {
HXLINE( 198)						 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 198)						 ::Dynamic To = 0;
HXDLIN( 198)						 ::Dynamic onComplete = null();
HXDLIN( 198)						if (::hx::IsNull( To )) {
HXLINE( 198)							To = 0;
            						}
HXDLIN( 198)						if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 198)							_this->fadeTween->cancel();
            						}
HXDLIN( 198)						_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(_this->_volume,( (Float)(To) ),((Float)2.2), ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            					}
HXLINE( 200)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.2), ::Dynamic(new _hx_Closure_0(_gthis)),5);
HXLINE( 210)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)1.2), ::Dynamic(new _hx_Closure_1(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 219)				this->dialogueList->remove(this->dialogueList->__get(0));
HXLINE( 220)				this->startDialogue();
            			}
            		}
...
void DialogueBox_obj::startDialogue(){
            	HX_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_230_startDialogue)
HXLINE( 231)		this->cleanDialog();
HXLINE( 237)		this->swagDialogue->resetText(this->dialogueList->__get(0));
HXLINE( 238)		this->swagDialogue->start(((Float)0.04),true,null(),null(),null());
HXLINE( 240)		::String _hx_switch_0 = this->curCharacter;
            		if (  (_hx_switch_0==HX_("bf",c4,55,00,00)) ){
HXLINE( 250)			this->portraitLeft->set_visible(false);
HXLINE( 251)			if (!(this->portraitRight->visible)) {
HXLINE( 253)				this->portraitRight->set_visible(true);
HXLINE( 254)				this->portraitRight->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 249)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("dad",47,36,4c,00)) ){
HXLINE( 243)			this->portraitRight->set_visible(false);
HXLINE( 244)			if (!(this->portraitLeft->visible)) {
HXLINE( 246)				this->portraitLeft->set_visible(true);
HXLINE( 247)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 242)			goto _hx_goto_11;
            		}
            		_hx_goto_11:;
            	}
...
void DialogueBox_obj::cleanDialog(){
            	HX_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_260_cleanDialog)
HXLINE( 261)		::Array< ::String > splitName = this->dialogueList->__get(0).split(HX_(":",3a,00,00,00));
HXLINE( 262)		this->curCharacter = splitName->__get(1);
HXLINE( 263)		this->dialogueList[0] = ::StringTools_obj::trim(this->dialogueList->__get(0).substr((splitName->__get(1).length + 2),null()));
            	}
