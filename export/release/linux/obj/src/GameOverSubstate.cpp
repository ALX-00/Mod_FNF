...
HXLINE(  27)			daBf = HX_("macia",27,68,16,03);
HXDLIN(  27)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(  29)			daBf = HX_("bf",c4,55,00,00);
            		}
            		_hx_goto_0:;
HXLINE(  32)		super::__construct();
HXLINE(  34)		::Conductor_obj::songPosition = ( (Float)(0) );
HXLINE(  36)		this->bf =  ::Boyfriend_obj::__alloc( HX_CTX ,x,y,daBf);
HXLINE(  37)		this->add(this->bf);
HXLINE(  39)		Float _hx_tmp = this->bf->getGraphicMidpoint(null())->x;
HXDLIN(  39)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,_hx_tmp,this->bf->getGraphicMidpoint(null())->y,1,1);
HXLINE(  40)		this->add(this->camFollow);
HXLINE(  42)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  42)		_hx_tmp1->play(::Paths_obj::sound((HX_("fnf_loss_sfx",6a,36,72,11) + this->stageSuffix),null()),null(),null(),null(),null(),null());
HXLINE(  43)		::Conductor_obj::changeBPM(100);
...
HXLINE( 110)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
