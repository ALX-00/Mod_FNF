...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_76_create,"LoadingState","create",0x65cff835,"LoadingState.create","LoadingState.hx",76,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_83_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",83,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_92_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",92,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_97_checkLibrary,"LoadingState","checkLibrary",0xd141a10c,"LoadingState.checkLibrary","LoadingState.hx",97,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_111_beatHit,"LoadingState","beatHit",0x12c36b24,"LoadingState.beatHit","LoadingState.hx",111,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_125_update,"LoadingState","update",0x70c61742,"LoadingState.update","LoadingState.hx",125,0x53ff9bc9)
...
void LoadingState_obj::create(){
            		...
            		void _hx_run( ::lime::utils::AssetLibrary lib){
            			...
            			void _hx_run( ::flixel::util::FlxTimer _){
            				HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_76_create)
HXLINE(  76)				introComplete();
            			}
...
HXLINE(  67)				if ((::PlayState_obj::storyWeek == 7)) {
HXLINE(  68)					_gthis->checkLibrary(HX_("ho",07,5b,00,00));
            				}
            				else {
HXLINE(  70)					_gthis->checkLibrary((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
            				}
            			}
            			else {
HXLINE(  72)				_gthis->checkLibrary(HX_("tutorial",9e,8f,b5,82));
            			}
HXLINE(  74)			Float fadeTime = ((Float)0.5);
HXLINE(  75)			::flixel::FlxG_obj::camera->fade(::flixel::FlxG_obj::camera->bgColor,fadeTime,true,null(),null());
HXLINE(  76)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start((fadeTime + ((Float)1.0)), ::Dynamic(new _hx_Closure_0(introComplete)),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
void LoadingState_obj::checkLoadSong(::String path){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_83_checkLoadSong)
HXDLIN(  83)		if (!(::openfl::utils::IAssetCache_obj::hasSound(::openfl::utils::Assets_obj::cache,path))) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            			void _hx_run( ::openfl::media::Sound _){
            				HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_92_checkLoadSong)
HXLINE(  92)				callback();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  85)			 ::lime::utils::AssetLibrary library = ::openfl::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  86)			::String symbolPath = ( (::String)(path.split(HX_(":",3a,00,00,00))->pop()) );
HXLINE(  91)			 ::Dynamic callback = this->callbacks->add((HX_("song:",c5,36,c7,80) + path));
HXLINE(  92)			::openfl::utils::Assets_obj::loadSound(path,null())->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
void LoadingState_obj::checkLibrary(::String library){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_97_checkLibrary)
HXLINE(  98)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  98)		bool _hx_tmp1 = ::openfl::utils::Assets_obj::hasLibrary(library);
HXDLIN(  98)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),98,HX_("LoadingState",15,62,ae,41),HX_("checkLibrary",13,df,f6,2c)));
HXLINE(  99)		if (::hx::IsNull( ::openfl::utils::Assets_obj::getLibrary(library) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
...
HXLINE( 102)			if (!(::lime::utils::Assets_obj::libraryPaths->exists(library))) {
HXLINE( 103)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Missing library: ",07,45,01,4f) + library)));
            			}
HXLINE( 105)			 ::Dynamic callback = this->callbacks->add((HX_("library:",df,f4,b1,42) + library));
HXLINE( 106)			::openfl::utils::Assets_obj::loadLibrary(library)->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
void LoadingState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_111_beatHit)
HXLINE( 112)		this->super::beatHit();
HXLINE( 114)		this->logo->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 115)		this->danceLeft = !(this->danceLeft);
HXLINE( 117)		if (this->danceLeft) {
HXLINE( 118)			this->gfDance->animation->play(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            		}
            		else {
HXLINE( 120)			this->gfDance->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            		}
            	}


void LoadingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_125_update)
HXDLIN( 125)		this->super::update(elapsed);
            	}
...
HXLINE( 137)		{
HXLINE( 137)			 ::flixel::FlxState nextState = this->target;
...
HXDLIN( 142)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 142)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXDLIN( 142)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 142)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXDLIN( 142)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 142)			goto _hx_goto_14;
            		}
            		_hx_goto_14:;
HXDLIN( 142)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
HXDLIN( 147)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 147)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXDLIN( 147)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 147)			goto _hx_goto_16;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXDLIN( 147)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 147)			goto _hx_goto_16;
            		}
            		_hx_goto_16:;
HXDLIN( 147)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
HXDLIN( 152)		 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(target,stopMusic);
HXDLIN( 152)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXDLIN( 152)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoadingState_obj,loadAndSwitchState,(void))
 ...
 ::flixel::FlxState LoadingState_obj::getNextState( ::flixel::FlxState target,::hx::Null< bool >  __o_stopMusic){
            		bool stopMusic = __o_stopMusic.Default(false);
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_156_getNextState)
HXLINE( 157)		if ((::PlayState_obj::storyWeek == 7)) {
HXLINE( 158)			::Paths_obj::setCurrentLevel(HX_("ho",07,5b,00,00));
            		}
            		else {
