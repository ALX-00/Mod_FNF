...
HXLINE(  60)		::String data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
...
HXLINE(  85)		::lime::utils::Assets_obj::registerLibrary(HX_("ho",07,5b,00,00),library);
HXLINE(  86)		{
HXLINE(  86)			::String v9 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN(  86)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v9);
            		}
HXLINE(  87)		{
HXLINE(  87)			::String v10 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  87)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v10);
            		}
...
HXLINE(  96)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  97)		if (::hx::IsNotNull( library )) {
HXLINE(  97)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  98)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  99)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE( 100)		if (::hx::IsNotNull( library )) {
HXLINE( 100)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 101)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE( 102)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE( 103)		if (::hx::IsNotNull( library )) {
HXLINE( 103)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 104)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE( 105)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE( 106)		if (::hx::IsNotNull( library )) {
HXLINE( 106)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 107)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 108)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 109)		if (::hx::IsNotNull( library )) {
HXLINE( 109)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 110)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 111)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 112)		if (::hx::IsNotNull( library )) {
HXLINE( 112)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 113)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 114)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 115)		if (::hx::IsNotNull( library )) {
HXLINE( 115)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 116)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 117)		library = ::lime::utils::Assets_obj::getLibrary(HX_("ho",07,5b,00,00));
HXLINE( 118)		if (::hx::IsNotNull( library )) {
HXLINE( 118)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 119)			::ManifestResources_obj::preloadLibraryNames->push(HX_("ho",07,5b,00,00));
            		}
HXLINE( 120)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 121)		if (::hx::IsNotNull( library )) {
HXLINE( 121)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 122)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
