...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_53_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",53,0xf7836789)
...
HXLINE(  40)		this->animation->add(HX_("macia",27,68,16,03),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  41)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  43)		::String _hx_switch_0 = _hx_char;
...
HXDLIN(  46)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE(  49)		this->scrollFactor->set(null(),null());
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_53_update)
HXLINE(  54)		this->super::update(elapsed);
HXLINE(  56)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  57)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  57)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 10);
HXDLIN(  57)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
