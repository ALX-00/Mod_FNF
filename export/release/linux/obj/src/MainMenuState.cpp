...
static const ::String _hx_array_data_205e8859_6[] = {
	HX_("https://www.kickstarter.com/projects/funkin/friday-night-funkin-the-full-ass-game",a5,2d,fa,b7),HX_("&",26,00,00,00),
};
...
HXLINE( 158)					::Sys_obj::command(HX_("/usr/bin/xdg-open",2e,30,af,50),::Array_obj< ::String >::fromData( _hx_array_data_205e8859_6,2));
            				}
            				else {
