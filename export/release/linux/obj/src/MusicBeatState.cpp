...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_118_fancyOpenURL,"MusicBeatState","fancyOpenURL",0x105d0074,"MusicBeatState.fancyOpenURL","MusicBeatState.hx",118,0xa1b2f108)
...
void MusicBeatState_obj::fancyOpenURL(::String schmancy){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_118_fancyOpenURL)
HXDLIN( 118)		::Sys_obj::command(HX_("/usr/bin/xdg-open",2e,30,af,50),::Array_obj< ::String >::__new(2)->init(0,schmancy)->init(1,HX_("&",26,00,00,00)));
            	}
