...
HXLINE( 336)			{
HXLINE( 336)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 336)				_g->set_y(_g->y);
            			}
...
HXLINE( 308)			{
HXLINE( 308)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 308)				_g->set_y((_g->y + 50));
            			}
