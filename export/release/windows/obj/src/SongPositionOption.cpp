...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_170_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",170,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_175_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",175,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_183_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",183,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_170_new)
HXLINE( 171)		super::__construct();
HXLINE( 172)		this->description = desc;
            	}
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_175_press)
HXLINE( 176)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 177)		this->display = this->updateDisplay();
HXLINE( 178)		return true;
            	}


::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_183_updateDisplay)
HXDLIN( 183)		::String _hx_tmp;
HXDLIN( 183)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 183)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 183)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 183)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}
