...
HXLINE(  76)		this->magenta->scrollFactor->set_y(((Float)0.18));
...
HXLINE( 127)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 129)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 131)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 131)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXDLIN( 160)					if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(HX_("https://www.kickstarter.com/projects/funkin/friday-night-funkin-the-full-ass-game",a5,2d,fa,b7)))) {
HXLINE( 160)						prefix = HX_("http://",52,75,cd,5a);
            					}
HXDLIN( 160)					::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("https://www.kickstarter.com/projects/funkin/friday-night-funkin-the-full-ass-game",a5,2d,fa,b7))),HX_("_blank",95,26,d9,b0));
            				}
            				else {
...
HXLINE( 232)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
