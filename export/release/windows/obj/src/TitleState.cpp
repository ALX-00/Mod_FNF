...
HXLINE( 454)		this->skippedIntro = false;
...
HXLINE( 208)		this->credTextShit =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("ninjamuffin99\nPhantomArcade\nkawaisprite\nevilsk8er",fd,7d,e3,3b),true,null());
...
HXLINE( 397)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,4));
            			...
            			break;
            			case (int)3: {
HXLINE( 400)				this->addMoreText(HX_("present",fb,3a,dc,39));
            			}
            			break;
            			case (int)4: {
HXLINE( 404)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 409)				if (::Main_obj::watermarks) {
HXLINE( 410)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,2));
            				}
            				else {
HXLINE( 412)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_22,2));
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 414)				if (::Main_obj::watermarks) {
HXLINE( 415)					this->addMoreText(HX_("KadeDeveloper",93,41,22,2c));
            				}
            				else {
HXLINE( 418)					this->addMoreText(HX_("Newgrounds",cc,13,58,ed));
HXLINE( 419)					this->ngSpr->set_visible(true);
            				}
            			}
            			break;
            			case (int)8: {
HXLINE( 423)				this->deleteCoolText();
HXLINE( 424)				this->ngSpr->set_visible(false);
            			}
            			break;
            			case (int)9: {
HXLINE( 430)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			...
            			break;
            			case (int)11: {
HXLINE( 433)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
HXLINE( 436)				this->deleteCoolText();
            			}
            			break;
            			case (int)13: {
HXLINE( 441)				this->addMoreText(HX_("Friday",ff,00,5d,e6));
            			}
            			break;
            			case (int)14: {
HXLINE( 444)				this->addMoreText(HX_("Night",b8,29,f7,2e));
            			}
            			break;
            			case (int)15: {
HXLINE( 447)				this->addMoreText(HX_("Funkin",51,26,e4,a3));
            			}
            			break;
            			case (int)16: {
HXLINE( 450)				this->skipIntro();
            			}
            			break;
            		}
            	}
...
void TitleState_obj::skipIntro(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_458_skipIntro)
HXDLIN( 458)		if (!(this->skippedIntro)) {
HXLINE( 460)			this->remove(this->ngSpr,null());
HXLINE( 462)			::flixel::FlxG_obj::camera->flash(-1,4,null(),null());
HXLINE( 463)			this->remove(this->credGroup,null());
HXLINE( 464)			this->skippedIntro = true;
            		}
            	}
