...
HX_DEFINE_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_190_new,"DistractionsAndEffectsOption","new",0x025cdf63,"DistractionsAndEffectsOption.new","Options.hx",190,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_195_press,"DistractionsAndEffectsOption","press",0x2a356946,"DistractionsAndEffectsOption.press","Options.hx",195,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_203_updateDisplay,"DistractionsAndEffectsOption","updateDisplay",0x58e59ffc,"DistractionsAndEffectsOption.updateDisplay","Options.hx",203,0x9d9a0240)

void DistractionsAndEffectsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_190_new)
HXLINE( 191)		super::__construct();
HXLINE( 192)		this->description = desc;
            	}
...
bool DistractionsAndEffectsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_195_press)
HXLINE( 196)		::flixel::FlxG_obj::save->data->__SetField(HX_("distractions",31,13,7d,60),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 197)		this->display = this->updateDisplay();
HXLINE( 198)		return true;
            	}


::String DistractionsAndEffectsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_203_updateDisplay)
HXDLIN( 203)		::String _hx_tmp;
HXDLIN( 203)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) ))) {
HXDLIN( 203)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 203)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 203)		return (HX_("Distractions ",af,07,e4,54) + _hx_tmp);
            	}
