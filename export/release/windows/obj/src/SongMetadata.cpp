...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_295_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",295,0x0d86f62d)
...
HXLINE( 299)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 298)		this->week = 0;
HXLINE( 297)		this->songName = HX_("",00,00,00,00);
HXLINE( 303)		this->songName = song;
HXLINE( 304)		this->week = week;
HXLINE( 305)		this->songCharacter = songCharacter;
            	}
