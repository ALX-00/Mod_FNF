...
HXLINE(  89)			::String URL = (HX_("https://kadedev.github.io/Kade-Engine/changelogs/changelog-",f5,d4,9e,ab) + ::OutdatedSubState_obj::needVer);
HXDLIN(  89)			::String prefix = HX_("",00,00,00,00);
HXDLIN(  89)			if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(URL))) {
HXLINE(  89)				prefix = HX_("http://",52,75,cd,5a);
            			}
HXDLIN(  89)			::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + URL)),HX_("_blank",95,26,d9,b0));
            		}
